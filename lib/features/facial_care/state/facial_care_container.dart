...
class FacialCareContainer extends StatefulWidget {
  final List<FacialService> initialServices;
  ...
  static Widget withServices(List<FacialService> services) {
    return FacialCareContainer(initialServices: services);
  }
...
class _FacialCareContainerState extends State<FacialCareContainer> {
  ...
  late List<FacialService> _services;
